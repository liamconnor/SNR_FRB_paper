...
%-- Excluded models??
 %* Double degenerate WD type 1a
 %* 
%-- Actual introduction type paragraph(s) --
\\
...
including merging white dwarfs (http://iopscience.iop.org/2041-8205/776/2/L39/)
and neutron stars (), blitzars, magnetars, and flaring galactic stars.
...
for 1ms scattering \citep{goldreich}. 
...
Though this is the basic narrative, observations \cite{} as well as simulations \cite{}
 ...
 difficult to model. 
%(http://iopscience.iop.org/0004-637X/796/2/82/pdf/0004-637X_796_2_82.pdf)
...
\cite{burke/smith} we get,

\begin{equation}
\textup{RM} \approx 0.81\,\textup{rad} / m^2 \, \times \frac{\left < B_{\parallel} \right >}{1 \mu G} \cdot \frac{\textup{DM}}{1 pc/cm^3} 
\end{equation}
...
typical values in our galaxy are 0.2 - 1$\mu G$. This gives RM's between $\sim 80-1200$
rad/m$^2$, which is consistent which the observed Faraday rotated FRB.


\subsection{Event Rates}
The daily FRB rate has been estimated at $\sim5-15\times10^4$ sky$^{-1}$ 
...
observed brightness temperature came from a giant pulse 
of the millisecond pulsar B1937+21, with T$_b\sim5\times10^{39}$
...
% \cite{http://adsabs.harvard.edu/abs/1988A%26A...202..166R}
% \cite{http://arxiv.org/pdf/0802.4424v1.pdf}.
\\
