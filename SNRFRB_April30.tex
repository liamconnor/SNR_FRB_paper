...
typical values in our galaxy are 0.2 - 1$\mu G$. The crab, for instance, has 
$| \left < B_{\parallel} \right >}| \sim 0.9 \mu G$. 
This gives RM's between $\sim 80-1200$
rad/m$^2$, which is consistent with the observed Faraday rotated FRB.
